...
showOptionValues(void)
{
  ...
  /***** -zerolags: Dump the raw spigot zerolags in 32-bit floats format to a file */
  if( !cmd.zerolagsP ) {
    printf("-zerolags not found.\n");
  } else {
    printf("-zerolags found:\n");
  }
...
usage(void)
{
  fprintf(stderr,"%s","   [-o outfile] [-nohdr] [-stdout] [-floats] [-zerolags] [-skip skip] [-numout numout] [-downsamp downsamp] [-lokill lokill] [-hikill hikill] [--] fitsfiles ...\n");
